                    ...
                    <div class="col-md-12">
                        <div class="contact-form-wrapper">
                            ...
                            <h3 class="contact-form__title text-shadow text-center">
                                @lang('Your Email')  {{auth()->user()->email}}
                            </h3>

                            <form action="{{route('user.verify_email')}}" method="post" class="contact-form">
                                @csrf
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-lg-12 text-center">
                                        <button type="submit" class="btn btn-danger btn-small btn-primary w-100">@lang('Submit')</button>
                                    </div>
                                </div>
                            </form>
                            ...
                            <div class="form-group ">
                                <p class="mt-2 text-center">@lang('Please check including your Junk/Spam Folder. if not found, you can') <a
