                    ...
                    <div class="col-md-12">
                        <div class="contact-form-wrapper">
                            ...
                            <h3 class="contact-form__title text-shadow text-center">
                                @lang('Your Mobile Number')  {{auth()->user()->mobile}}
                            </h3>

                            <form action="{{route('user.verify_sms')}}" method="post" class="contact-form">
                                @csrf
                                <div class="form-row">
                            ...
                            <div class="form-group ">
                                <p class="mt-2 text-center">@lang("Didn't get SMS?") <a
