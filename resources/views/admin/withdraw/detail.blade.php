            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    <div class="p-3 bg--white">
                        <div class="">
                            <img src="{{$methodImage}}" alt="profile-image" class="b-radius--10 withdraw-detailImage" >
                        </div>
                    </div>
                    <ul class="list-group">
            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    @if($withdrawal->status == 2)
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <button class="btn btn--success ml-1 approveBtn" data-toggle="tooltip" title="" data-original-title="Approve" data-id="{{ $withdrawal->id }}" data-amount="{{ getAmount($withdrawal->final_amount) }} {{$withdrawal->currency}}"> <i class="fas la-check"></i> @lang('Approve') </button>

                                <button class="btn btn--danger ml-1 rejectBtn" data-toggle="tooltip" title="" data-original-title="Reject" data-id="{{ $withdrawal->id }}" data-amount="{{ getAmount($withdrawal->final_amount) }} {{$withdrawal->currency}}">
